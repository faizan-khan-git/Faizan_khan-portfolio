      ...
      >
        ...
        <div className="w-full lg:w-2/3 flex flex-col gap-6">
          ...
          <p className="text-lg md:text-xl text-zinc-400 leading-relaxed font-light">
            Results-oriented Computer Science student at IIIT Guwahati specializing in full-stack development, scalable backend systems, and GenAI applications. Proven expertise in designing RESTful APIs, microservices, and RAG pipelines.
          </p>
          ...
          <div className="grid sm:grid-cols-2 gap-4 mt-4">
            <div className="glass-card p-5 rounded-2xl flex items-start gap-4 hover:bg-zinc-800/40 transition-colors">
              ...
              <div>
                <h4 className="text-zinc-100 font-semibold mb-1">Microservices Architecture</h4>
                <p className="text-sm text-zinc-400">Designing highly scalable, decoupled backend systems.</p>
              </div>
            </div>
            ...
            <div className="glass-card p-5 rounded-2xl flex items-start gap-4 hover:bg-zinc-800/40 transition-colors">
              ...
              <div>
                <h4 className="text-zinc-100 font-semibold mb-1">REST API Design</h4>
                <p className="text-sm text-zinc-400">Building secure, high-performance API layers.</p>
              </div>
            </div>
          </div>
        </div>
